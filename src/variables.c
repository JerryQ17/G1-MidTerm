...
const board vec[96] = {                                                                                                     //棋盘(用函数初始化非常困难，不如打表)
    ...
    {RED,L,662,637},{GREEN,L,623,637},{YELLOW,L,583,637},       //     |
    ...
    {RED,U,328,420},{GREEN,U,328,381},{YELLOW,U,328,343},      //     |
    ...
    {BLUE,R,622,50},{RED,R,662,50},{GREEN,R,701,50},           //     |
    ...
    {BLUE,D,914,305},{RED,D,914,344},{GREEN,D,914,381},        //     |
    ...
    {RED,L,860,343},{RED,L,820,343},{RED,L,781,343},           //     |
    {RED,L,742,343},{RED,L,702,343},{RED,L,659,343},           //72-77是红色终点
    {GREEN,U,623,580},{GREEN,U,623,541},{GREEN,U,623,501},     //     |
    {GREEN,U,623,462},{GREEN,U,623,423},{GREEN,U,623,381},     //78-83是绿色终点
    {YELLOW,R,385,344},{YELLOW,R,425,344},{YELLOW,R,464,344},  //     |
    {YELLOW,R,504,344},{YELLOW,R,543,344},{YELLOW,R,587,344},  //84-89是黄色终点
    {BLUE,D,622,106},{BLUE,D,622,145},{BLUE,D,622,184},        //     |
    {BLUE,D,622,224},{BLUE,D,622,263},{BLUE,D,622,307}        //90-95是蓝色终点
};                                                                                                                               //-------------